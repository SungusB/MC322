...
public class MenuPosTurno {
    ...
    private static boolean salvarSolicitado = false;
    public static boolean foiSalvarSolicitado() { return salvarSolicitado; }
    private static void solicitarSalvar() { salvarSolicitado = true; }
    ...
    public boolean exibir(Heroi heroi, boolean lootDisponivel) {
        ...
        while (true) {
            ...
            switch (opcao) {
                ...
                case 5 -> {
                    solicitarSalvar();
                    System.out.println("Jogo será salvo ao sair para o menu principal.");
                    return false;
                    return true;
                }
            }
